...
tools.register({
  name: "send_picture",
  description: "Send one or more images to the user. Provide image URLs and optional Referer.",
  parameters: {
    type: "object",
    properties: {
      images: {
  ...
  execute: async (args, ctx) => {
    ...
    if (!localPaths.length) return "All images failed to download"
