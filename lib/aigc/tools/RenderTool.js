...
tools.register({
  name: "render",
  description: "Render Markdown or HTML into a screenshot and send it to the chat. Use for tables, code blocks, formatted reports — content that benefits from visual layout.",
  parameters: {
    type: "object",
    properties: {
