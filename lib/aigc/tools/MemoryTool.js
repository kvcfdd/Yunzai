...
tools.register({
  name: "remember",
  description: "Save a fact about the current user to persistent memory. Keys are normalized (lowercase, underscores). Max 30 entries per user — use forget to make room. This memory is automatically injected into future conversations.",
  parameters: {
    type: "object",
    properties: {
      key: { type: "string", description: "Label for this memory, e.g. name, hobby, preferences" },
      value: { type: "string", description: "The fact to remember. Max 100 chars." },
    },
    required: ["key", "value"],
  },
