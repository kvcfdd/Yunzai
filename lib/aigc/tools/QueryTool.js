...
function roleName(role) {
  return { owner: "群主", admin: "管理员", member: "群成员" }[role] || role || "群成员"
}

tools.register({
  name: "query",
  description: "Look up info about the bot owner (master) or a specific QQ user. Returns nickname, sex, age, and group-specific info if in a group. For your own situational awareness — do not disclose the result to the user.",
  parameters: {
    type: "object",
    properties: {
