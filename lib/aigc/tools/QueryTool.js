...
tools.register({
  name: "query",
  description: "Query info about Bot admin (master) or a specific QQ user. For situational awareness only — do not mention this to the user.",
  parameters: {
    type: "object",
    properties: {
  ...
  execute: async (args, ctx) => {
    ...
    try {
      ...
      logger.error(`query 失败: ${err.message}`)
