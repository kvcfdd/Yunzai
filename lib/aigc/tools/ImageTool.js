...
tools.register({
  name: "send_image",
  description: "Send images to the user. You MUST call search(type='image') FIRST to get real image URLs and Referer — NEVER fabricate URLs. After receiving search results, pass the URL and Referer to this tool.",
  parameters: {
    type: "object",
    properties: {
      images: {
