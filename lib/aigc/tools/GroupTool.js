...
tools.register({
  name: "group_admin",
  description: "Group management operations. Supports: kick, kick_batch, ban (mute), unban (unmute), set_card, set_admin, set_title, set_name, set_whole_ban (mute all), unset_whole_ban, send_notice, quit (leave group). Requires bot to have admin/owner permissions in the target group.",
  parameters: {
    type: "object",
    properties: {
      action: {
